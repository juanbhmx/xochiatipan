        ...
        <div class="row">
          <div class="col-lg-12">
              <div class="banner-heading">
                <h1 class="banner-title">Confirma tu cita</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center">
                      <li class="breadcrumb-item"><a href="#">recuerda guardar tu numero de cita</a></li>
                    </ol>
                </nav>
              </div>
          </div><!-- Col end -->
          ...
          <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title">
                  <a data-toggle="collapse" href="#collapse1">Guarda tu Numero de cita (click)</a>
                </h4>
              </div>
              <div id="collapse1" class="panel-collapse collapse">
              <div class="col-md-9" id="folio"><?php include('cargadatos.php');?></div>
              </div>
            </div>
            
            <button class="btn btn-primary solid blank"  id="myBtmodal" type="button" name="Submit" data-toggle="modal" data-target="#modalForm" data-backdrop="false">Confirmar Cita</button>
            </div>  
          </div>
              ...
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel">Verifica</h4>
                      </div>
                      <!-- Modal Body -->
                      <div class="modal-body">
                          ...
                          <form role="form">
                              ...
                              <div class="col-md-9" id="folio">¿Tus datos son correctos?</div>
                              </div>
                          </form>
                      </div>
                      <!-- Modal Footer -->
...
<script>
function cancel() {
  window.location.replace("cita.php");
}
</script>
                          <div class="col-md-9" id="folio"></div>
                          <button type="button" class="btn btn-primary submitBtn" id="BtnId" onclick="cancel()" data-dismiss="modal">Cancelar Datos</button>
                <button type="button" class="btn btn-primary submitBtn" id="BtnConf" onclick="page()" data-dismiss="modal">Confirmar</button>
            </div>
        </div>
    </div>
</div>
