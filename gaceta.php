          ...
          <nav class="navbar navbar-expand-lg navbar-light p-0">
            ...
            <div id="navbar-collapse" class="collapse navbar-collapse">
              ...
              <li class="nav-item dropdown active">
                    ...
                    <li class="nav-item dropdown"><a href="#">Gaceta</a>                     
                    </li>
                    <li class="nav-item dropdown">
        ...
        <div class="row">
          <div class="col-lg-12">
              <div class="banner-heading">
                <h1 class="banner-title">Gaceta</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center">
                      <li class="breadcrumb-item"><a href="#">Municipal</a></li>
                    </ol>
                </nav>
              </div>
          </div><!-- Col end -->
  ...
  <div class="container">
    <div class="row">
      <div class="col-xl-10 col-lg-6">
        <div class="sidebar">
          <div class="widget">
            <h3 class="widget-title">Gaceta Municipal</h3>
            

            <ul class="nav service-menu">
            <?php
                          require("ok.php");
                          $query=mysqli_query($conn,"SELECT nombre, pdf From tbl_gaceta;");
                          while($fila=mysqli_fetch_array($query)){        
                    echo '
               <li marker>
                <a href="'.$fila['pdf'].'"><strong>'.$fila['nombre'].'</strong> 
