...
<section id="main-container" class="main-container">
  <div class="container">
    ...
    <div class="row">
      ...
      <!--empieza formulario--->
        <form name="nueva_cita" id="contact-form" action="agendacita.php" method="post">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label>CURP</label>
                <input class="form-control form-control-email" min="18" maxlength="18" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" name="email" id="email" placeholder="" type="text"
                  required>
              </div>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <input type="date"  class="form-control form-control-message" name="fecha" id="fecha" required></input>
          </div>
          </div>
          <div class="col-md-4">
              <div class="form-group">
                <label>Horas Disponibles</label>
                <!-- <input class="form-control form-control-name"  name="hora" id="hora" placeholder="" type="time" required> -->
                <select class="combobox form-control" name="hora" id="hora" name="ar" id="ar" required>
                  <option value="" selected="selected">-- Horas Disponibles--</option>
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              <select class="combobox form-control" name="ar" id="ar" required>
                ...
                <option value="Desarrollo Humano y Social Municipal">Desarrollo Humano y Social Municipal</option>;
                <option value="Tesoreria Municipal">Tesoreria Municipal</option>;
                <option value="Desarrollo Económico">Desarrollo Económico</option>;
                <option value="Secretaria General Municipal">Secretaria General Municipal</option>;
                <option value="Obras Publicas">Obras Publicas</option>;
                <option value="Oficialia Mayor">Oficialia Mayor</option>;
                <option value="Servicios Públicos Municipales">Servicios Públicos Municipales</option>;
                <option value="Seguridad Pública Municipal - Transito y Vialidad">Seguridad Pública Municipal - Transito y Vialidad</option>;
          ...
          <div class="text-center"><br>
            <button class="btn btn-primary solid blank" id="myBtn" type="submit" name="Submit">Agendar Cita</button>
          </div>
