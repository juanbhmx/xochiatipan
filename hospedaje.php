...
================================================== -->
  <meta charset="utf-8">
  <title>Hospedaje & Restaurantes</title>
        ...
        <div class="row">
          <div class="col-lg-12">
              <div class="banner-heading">
                <h1 class="banner-title">Hoteles & Restaurantes</h1>
...
<section id="news" class="news">
  <div class="container">
    ...
    <?php
                          require("ok.php");
                          $query=mysqli_query($conn,"SELECT hotel, direccion, descripcion, telefono, imagen From tbl_hoteles;");
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="latest-post">
              ...
              <h4 class="post-title">
                   ...
                   <p><strong>Direcciòn:</strong> '.$fila['direccion'].' </p> 
                <div class="latest-post-meta">
                    <span class="post-item-date"> 
                      <i class="fa fa-clock-o"></i> <strong>Contacto:</strong> '.$fila['telefono'].'
                    </span>
                </div>
                <a  class="btn btn-primary solid blank" href="tel:'.$fila['telefono'].'">Llamar</a>
              </div>
          </div>
        </div> <hr/>
        ';
